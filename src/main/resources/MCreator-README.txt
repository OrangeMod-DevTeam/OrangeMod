...
3. Mod author and end users are not allowed to remove MCreator branding/credits from the mod
   (e.g. renaming files, editing mcmod.info or do any other changes that would hide or cover
...
Full license for MCreator 1.9.1, which was used to make and export this mod, can be found
   on https://www.pylo.co/static/mcreator/repository/191/LICENSE
...
This mod was built and exported on 05. 01. 2020 using MCreator 1.9.1.